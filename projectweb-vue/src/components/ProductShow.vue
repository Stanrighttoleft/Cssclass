<template>
  <div
    class="container-fluid shows m-3 p-2 productShow overflow-hidden position-relative scroll-wrapper"
  >
    <div
      ref="productDiv"
      class="d-flex flex-row flex-nowrap overflow-hidden product-row position-relative"
    >
      <motion.div
        v-for="product in filteredAndSortedProducts"
        :key="product.id"
        class="mx-2 position-relative rounded-3 shadow-sm bg-white"
      ...
      >
        ...
        >
          ...
          <div class="rounded-3">
            <div class="d-flex text-wrap" style="width: 200px">
              <p class="rounded-3 m-1 info">{{ product.title }}</p>
            </div>
            <div class="rounded-3 m-1">
    ...
    <!-- Navigation -->
    <div
      class="navigation position-absolute d-flex start-0 end-0 justify-content-between px-1"
    >
