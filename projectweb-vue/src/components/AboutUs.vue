    ...
    <div class="row bg-warning">
      ...
      <div class="col-lg-6 col-md-9">
        ...
        <div class="about d-flex align-items-center">
          <span class="text-white abouttext"
            >在每一個細節中{{ displayedText }}</span
          >
        </div>
      </div>
    </div>
...
const contents = [
  "下苦功把事情做得最好，讓每個收到貨的人都像是收到國外的禮物般受到尊重的感覺。很多時候物流得不方便讓我們在選購東西的時候有了猶豫，即使知道商品是好的，但就是不容易取得，澳打團購就是要彌補這塊鴻溝，讓消費者在團購國外商品時也能夠買得安全又安心。",
  "用心思把每樣東西做到位，把顧客的東西當作自己的東西一樣全程追蹤和把關，在每一個環節都做到位。",
  "用毅力做著同個事業，把每個步驟都做到位，把顧客放在第一位。",
  "用行動在每個任務上都用上全力，主動關心每個需求。",
];
